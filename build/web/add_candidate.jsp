...
<!--<link href="css/styles.css" rel="stylesheet" />-->
                        ...
                        <div class="row">
                            <div class="row">
                                ...
                                %>
                                                              ...
                                                              <div class="card-body">
                                                                  <form style="margin: 10px; width: 50%; margin-left: 20%; "  method="post" action="Add_candidate" enctype="multipart/form-data" autocomplete="off" >

                              <div class="form-group row">
                                <label for="inputPassword" class="col-sm-3  col-form-label">Election</label>    
                            <div class="col-sm-8">
  ...
  <%  while (rs.next()) {%>
                            ...
                            <div class="form-group row">
                                <label for="inputPassword" class="col-sm-3  col-form-label">Candidate Name</label>    
                            <div class="col-sm-8">
                          <div class="input-group date" id="datepicker">
                          ...
                          <div class="input-group date" id="datepicker">
                            ...
                            <input type="text" class="form-control" placeholder="Class Name" name="party_name" required="required"  />
                          </div><br>
                            </div>
                            ...
                            <div class="col-sm-8">
                          <div class="input-group date" id="datepicker">
                              <input type="text" class="form-control" placeholder="Address" name="address" required="required" autocomplete="off" />
                            </div><br>
                            </div><!-- comment -->
                            
                            <label for="inputPassword" class="col-sm-3  col-form-label">Phone No</label>    
                            <div class="col-sm-8">
                          <div class="input-group date" id="datepicker">
                          ...
                          <div class="input-group date" id="datepicker">
                            <input type="file" class="form-control" placeholder="Photo" name="photo" accept="image/x-png,image/gif,image/jpeg" onchange="loadFile(event)" required="required"  />
                                ...
                                <div class="col-sm-20" style="float: right">
